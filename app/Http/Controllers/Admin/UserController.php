...
class UserController extends Controller
{
    ...
    public function user_role(User $user,$id)
    {
        $data=User::find($id);
        $datalist=Role::all()->sortBy('name');
    ...
    public function user_role_store(Request $request,User $user,$id)
    {
        ...
        $user->roles()->attach($roleid); #many to many ilişkisine role ekler
    ...
    public function user_role_delete(Request $request,User $user, $userid,$roleid)
    {
        ...
        #many to many ilişkisine role siler
        return redirect()->back()->with('success','Role delete to user');
    }
