                                ...
                                <div class="card tryal-gradient">
                                    <div class="card-body tryal row">
                                        ...
                                        <div class="col-xl-5 col-sm-6">
                                            <img src="{{asset('assets')}}/admin/images/chart.png" alt="" class="sd-shape">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body px-0">
                                        ...
                                        <div class="d-flex justify-content-between recent-emails">
                                            <div class="d-flex">
                                                <div class="profile-k">
                                                    <img src="{{asset('assets')}}/admin/images/profile/small/pic6.jpg" alt="">
                                                </div>
                                                <div class="ms-3">
                                        ...
                                        <div class="d-flex justify-content-between recent-emails">
                                            <div class="d-flex">
                                                <div class="profile-k">
                                                    <img src="{{asset('assets')}}/admin/images/profile/small/pic8.jpg" alt="">
                                                </div>
                                                <div class="ms-3">
                                                    <h4 class="fs-18 font-w500">How to improve project management flows</h4>
                                                    <span class="font-w400 d-block">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do<br> eiusmod tempor incididunt ut labore et dolore magna aliqua...</span>
                                            ...
                                            <div class="card-body pb-0">
                                                <div class="project-details">
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        <div class="d-flex align-items-center">
																	<span class="big-wind">
																		<img src="{{asset('assets')}}/admin/images/big-wind.png" alt="">
																	</span>
                                                            <div class="ms-3">
                                                                <h4>Big Wind</h4>
                                                ...
                                                <div class="project-details">
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        <div class="d-flex align-items-center">
																	<span class="big-wind">
																		<img src="{{asset('assets')}}/admin/images/circle-hunt.png" alt="">
																	</span>
                                                            <div class="ms-3">
                                                                <h4>Circle Hunt</h4>
                                                                <span class="fs-14 font-w400">Creative Agency</span>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body px-0">
                                        ...
                                        <div class="msg-bx d-flex justify-content-between align-items-center">
                                            <div class="msg d-flex align-items-center w-100">
                                                <div class="image-box">
                                                    <img src="{{asset('assets')}}/admin/images/profile/small/pic7.jpg" alt="">
                                                </div>
                                                <div class="ms-3 w-100">
                                        ...
                                        <div class="msg-bx d-flex justify-content-between align-items-center">
                                            <div class="msg d-flex align-items-center w-100">
                                                <div class="image-box active">
                                                    <img src="{{asset('assets')}}/admin/images/profile/small/pic4.jpg" alt="">
                                                </div>
                                                <div class="ms-3 w-100">
                                        ...
                                        <div class="msg-bx d-flex justify-content-between align-items-center">
                                            <div class="msg d-flex align-items-center w-100">
                                                <div class="image-box active">
                                                    <img src="{{asset('assets')}}/admin/images/profile/small/pic3.jpg" alt="">
                                                </div>
                                                <div class="ms-3 w-100">
                                        ...
                                        <div class="msg-bx d-flex justify-content-between align-items-center">
                                            <div class="msg d-flex align-items-center w-100">
                                                <div class="image-box active">
                                                    <img src="{{asset('assets')}}/admin/images/profile/small/pic5.jpg" alt="">
                                                </div>
                                                <div class="ms-3 w-100">
